...
import {
  GetCarsServerInput,
  GetCarsServerOutput,
} from "../server/operations/GetCars";
import {
  PostCarsServerInput,
  PostCarsServerOutput,
} from "../server/operations/PostCars";
import {
...
export const deserializeGetCarsRequest = async(
  output: __HttpRequest,
  context: __SerdeContext
): Promise<GetCarsServerInput> => {
  ...
  if (query != null) {
    if (query["id"] !== undefined) {
      ...
      if (Array.isArray(query["id"])) {
        ...
        queryValue = query["id"] as string;
      }
      contents.id = queryValue;
    }
  }
...
export const deserializePostCarsRequest = async(
  output: __HttpRequest,
  context: __SerdeContext
): Promise<PostCarsServerInput> => {
  const contentTypeHeaderKey: string | undefined = Object.keys(output.headers).find(key => key.toLowerCase() === 'content-type');
  if (contentTypeHeaderKey != null) {
    const contentType = output.headers[contentTypeHeaderKey];
    if (contentType !== undefined && contentType !== "application/json") {
  ...
  const doc = take(data, {
    'items': _ => de_CarList(_, context),
  });
  Object.assign(contents, doc);
  return contents;
}

export const serializeGetCarsResponse = async(
  input: GetCarsServerOutput,
...
export const serializePostCarsResponse = async(
  input: PostCarsServerOutput,
  ctx: ServerSerdeContext
): Promise<__HttpResponse> => {
  const context: __SerdeContext = {
    ...ctx,
...
export const serializeBadRequestErrorError = async(
  ...
  const statusCode: number = 400
  let headers: any = map({}, isSerializableHeaderValue, {
    'x-amzn-errortype': "BadRequestError",
    'content-type': 'application/json',
  });
  let body: any;
  body = JSON.stringify(take(input, {
...
export const serializeInternalFailureErrorError = async(
  input: InternalFailureError,
  ctx: ServerSerdeContext
): Promise<__HttpResponse> => {
  const context: __SerdeContext = {
    ...ctx,
  ...
  const statusCode: number = 500
  let headers: any = map({}, isSerializableHeaderValue, {
    'x-amzn-errortype': "InternalFailureError",
    'content-type': 'application/json',
  });
  let body: any;
  body = JSON.stringify(take(input, {
...
export const serializeNotAuthorizedErrorError = async(
  input: NotAuthorizedError,
  ctx: ServerSerdeContext
): Promise<__HttpResponse> => {
  const context: __SerdeContext = {
    ...ctx,
  ...
  let headers: any = map({}, isSerializableHeaderValue, {
    'x-amzn-errortype': "NotAuthorizedError",
    'content-type': 'application/json',
  });
  let body: any;
  body = JSON.stringify(take(input, {
...
const se_CarList = (
  ...
  return input.filter((e: any) => e != null).map(entry => {
    return se_Car(entry, context);
  });
}

/**
 * deserializeAws_restJson1Car
 */
const de_Car = (
  output: any,
  context: __SerdeContext
...
/**
 * deserializeAws_restJson1CarList
 */
const de_CarList = (
  output: any,
  context: __SerdeContext
  ...
  const retVal = (output || []).map((entry: any) => {
    if (entry === null) {
      throw new TypeError('All elements of the non-sparse list "uk.co.motorway#CarList" must be non-null.');
    }
    return de_Car(entry, context);
  });
  return retVal;
}
